<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminmembermanagement.aspx.cs" Inherits="Boi_wala.adminmembermanagement" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                             ...
                             <img width="100px"src="imgs/login8.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="col-5 mx-auto">
                         <asp:Button class="btn btn-lg btn-block btn-danger" runat="server" Text="Delete User" OnClick="Unnamed4_Click" />
                       <!-- <asp:Button ID="Button2" class="btn btn-lg btn-block btn-danger" runat="server" Text="Delete User" />
                         -->
                     </div>
                  </div>
               </div>
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:boiwalaConnectionString3 %>" SelectCommand="SELECT * FROM [member_master_table]"></asp:SqlDataSource>
                     <div class="col">
